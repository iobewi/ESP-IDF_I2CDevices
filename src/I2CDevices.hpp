...
public:
     ...
     */
    I2CDevices(i2c_port_t port, gpio_num_t sda, gpio_num_t scl, uint16_t addr, uint32_t freq = CONFIG_I2C_MASTER_FREQUENCY);
     ...
     */
    I2CDevices(i2c_master_bus_handle_t bus, uint16_t addr, uint32_t freq = CONFIG_I2C_MASTER_FREQUENCY);
